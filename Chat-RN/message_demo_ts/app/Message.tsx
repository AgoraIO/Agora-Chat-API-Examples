...
export function MessageScreen({
  route,
}: MessageScreenProps): React.ReactElement {
  ...
  const voiceRef = React.useRef<VoiceHandler | undefined>(undefined);
  const [visible, setVisible] = React.useState<boolean>(false);
  const msgBubbleDataRef = React.useRef<MessageItemType | undefined>(undefined);
  ...
  RenderVoiceButton.displayName = "RenderVoiceButton";
