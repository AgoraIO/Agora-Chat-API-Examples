...
type MessageBubbleProps = { item: MessageItemType };
...
export const StateLabel = React.memo(
  ({ state }: { state?: MessageItemStateType }) => {
    if (state === "sending") {
      ...
      return <AntDesign name="exclamation-circle" size={12} color="red" />;
    } else {
...
const RenderRecallMessage = (props: MessageItemType): React.ReactElement => {
...
function TextMessageRenderItem({
  item,
...
const TextMessageBubble = React.memo(TextMessageRenderItem);

export const FileMessageRenderItemDefault = React.memo(
  function FileMessageRenderItem({
    item,
  }: MessageBubbleProps): React.ReactElement | null {
    const { width: screenWidth } = useWindowDimensions();
...
const FileMessageBubble = FileMessageRenderItemDefault;

const ImageMessageBubble = React.memo(function ImageMessageRenderItem({
  item,
}: MessageBubbleProps): React.ReactElement | null {
...
const VoiceMessageBubble = React.memo(function VoiceMessageRenderItem({
  item,
}: MessageBubbleProps): React.ReactElement | null {
...
const VideoMessageBubble = React.memo(function VideoMessageRenderItem({
  item,
}: MessageBubbleProps): React.ReactElement | null {
...
function MessageBubbleCell({
  ...
  switch (item.type) {
    case ChatMessageType.TXT:
      content = <TextMessageBubble item={item} />;
      break;
    case ChatMessageType.IMAGE:
      content = <ImageMessageBubble item={item} />;
      break;
    case ChatMessageType.VOICE:
      content = <VoiceMessageBubble item={item} />;
      break;
    case ChatMessageType.VIDEO:
      content = <VideoMessageBubble item={item} />;
      break;
    case ChatMessageType.FILE:
      content = <FileMessageBubble item={item} />;
      break;
    default:
      break;
  }
...
export function MessageBubbleList(
  ...
  return (
    <FlatList
      ...
      data={items}
      extraData={items}
      renderItem={(info) => <MessageBubbleCell info={info} />}
